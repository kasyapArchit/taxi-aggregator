...
import iiitb.ess201a7.r16064.*;
import iiitb.ess201a7.r16008.*;
import iiitb.ess201a7.r16037.*;
import iiitb.ess201a7.r16105.*;
import iiitb.ess201a7.r16124.*;
import iiitb.ess201a7.r16085.*;
...
public class Demo {
	...
	public static void main(String[] args) {
		...
		{
			Fleet f1 = new Fleet16064("blue"); // note: colour currently not used by Display
			pf.addFleet(f1);
			fleets.add(f1);
			
			//f1 = new Fleet16008("green"); // note: colour currently not used by Display
			//pf.addFleet(f1);
			//fleets.add(f1);
			
			//f1= new Fleet16037("red"); // note: colour currently not used by Display
			//pf.addFleet(f1);
			//fleets.add(f1);
			
			//f1 = new Fleet16105("black"); // note: colour currently not used by Display
			//pf.addFleet(f1);
			//fleets.add(f1);
			
			//f1 = new Fleet16124("yellow"); // note: colour currently not used by Display
			//pf.addFleet(f1);
			//fleets.add(f1);
			
			//f1 = new Fleet16085("orange"); // note: colour currently not used by Display
			//pf.addFleet(f1);
			//fleets.add(f1);
		}
